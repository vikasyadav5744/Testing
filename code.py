...
with col2:
    st.write(f"""<div style="background-color:#d9bc6c; font-size:20px; padding: 5px; border-radius: 5px;text-align: center; margin:3px, color:#112e16;"> Weekly Range Two:- {ressis_two} - {support_two} </div>""", unsafe_allow_html=True)   
