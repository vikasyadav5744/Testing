...
with tab3:
    ...
    if newdata is not None:
        ...
        if spot2>0:
            ...
            with col1:
                st.write(f"""<div style="background-color: #7dc9aa; font-size:20px; padding: 5px; border-radius: 5px; text-align: center; margin:3px;"> CALLs OI :- {OICE_state.iloc[0]}</div>""", unsafe_allow_html=True)
            with col2:
