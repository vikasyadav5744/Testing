...
def apply_color007(df):
    ...
    style_df['cvper'] = np.where(df['cvper'] < 0, 'background-color:#63856b', np.where(df['cvper'] > 0, 'background-color: #63856b', 'background-color: #6f7a71')).
    style_df['pvper'] = np.where(df['pvper'] < 0, 'background-color:#63856b', np.where(df['pvper'] > 0, 'background-color: #63856b', 'background-color: #6f7a71'))
    return style_df
