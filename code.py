...
def apply_color007(df):
    ...
    style_df['CALL_CHNG'] = np.where(df['ce_intra'] < 0, 'background-color: #a6b5bf', np.where(df['ce_intra'] > 0, 'background-color: #138ce8', 'background-color: #6f7a71'))
    style_df['ce_intra'] = np.where(df['ce_intra'] < 0, 'background-color: #a6b5bf', np.where(df['ce_intra'] > 0, 'background-color: #138ce8', 'background-color: #6f7a71'))
    style_df['PUT_CHNG'] = np.where(df['pe_intra'] < 0, 'background-color: #a6b5bf', np.where(df['pe_intra'] > 0, 'background-color:#138ce8', 'background-color: #6f7a71'))
    style_df['pe_intra'] = np.where(df['pe_intra'] < 0, 'background-color: #a6b5bf', np.where(df['pe_intra'] > 0, 'background-color: #138ce8', 'background-color: #6f7a71'))
    return style_df
